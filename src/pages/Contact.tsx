    ...
    <>
      ...
      <section className="section workflow-section">
        <div className="section-heading center">
          ...
          <h2>Present Vymora to shop owners with confidence</h2>
        ...
        <div className="deploy-grid">
          <article>
            ...
            <a href="mailto:mohanrajauria@gmail.com?subject=Vymora%20Demo%20Request" className="button secondary">Email for Demo</a>
          </article>
          <article>
            ...
            <a href="https://github.com/algospider/Vymora" target="_blank" rel="noreferrer" className="button secondary">GitHub Repository</a>
          </article>
          <article>
